...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <a
		class="navbar-brand header-img" href=""> <img
	...
	<div class="d-flex" id="wrapper">
		...
		<div class="bg-light border-right" id="sidebar-wrapper">
			<div class="list-group list-group-flush">
				<a href="AccountDetails.jsp"
					class="list-group-item active-link list-group-item-action">Account
					Details</a> 
		...
		<div id="page-content-wrapper">
			...
			<%
				try {
					...
					String query = "select * from AccountDetails where EMAIL_ID='" + uname + "'";
			...
			<table border=1 align=center style="text-align: center">
				...
				<tr>
					<th>Account No</th>
					<td><%=rs1.getString("ACCOUNT_NO")%></td>
				</tr>
				<tr>
					<th>Account Holder's Name</th>
					<td><%=rs1.getString("ACCOUNT_HOLDER_NAME")%></td>
				</tr>
				<tr>
					<th>Account Type</th>
					<td><%=rs1.getString("ACCOUNT_TYPE")%></td>
				</tr>
				<tr>
					<th>Balance</th>
					<td>Rs <%=rs1.getLong("BALANCE")%></td>
				</tr>
				<tr>
					<th>Branch Name</th>
				...
				<%
					query = "select * from BranchDetails where Branch_Name='" + rs1.getString("BRANCH_NAME") + "'";
					}
		...
		<!-- Font Awesome CDN -->
		<script src="https://kit.fontawesome.com/66c71429b9.js"
